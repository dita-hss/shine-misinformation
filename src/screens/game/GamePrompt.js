        ...
        return (
          <div className="max-w-2xl mx-auto py-9 space-y-6">
            <p className="text-justify text-xl text-gray-900 leading-relaxed font-bold">
              ...
              normally would in real life (e.g., liking, disliking, sharing, or
              no engagement, etc.). Then, click “next post”. You will then be
              asked some questions about the content you just saw before the
              next post is shown. If you don't want to engage with a particular
              post, that is okay, just click “next post”, but you will still be
      ...
      case 2:
        return (
          <div className="max-w-2xl mx-auto py-6 space-y-6">
            <p className="text-justify text-xl text-gray-900 leading-relaxed font-bold">
              For this next task, you will do the same exact thing as before, in
              that you should engage with the content as you normally would in
              real life (e.g., liking, disliking, sharing, or no engagement,
              etc.), with the only difference being that the posts will not
              contain images.
            </p>
            <p className="text-center text-xl text-gray-900 leading-relaxed font-bold">
              Please let the experimenter know once you have completed reading
        ...
        return (
          <div className="max-w-2xl mx-auto py-6 space-y-6">
            <p className="text-justify text-xl text-gray-900 leading-relaxed font-bold">
              ...
              you think it is true or not. Once you have this judgment in mind,
              proceed to then think of 2 reasons why your initial judgment might
              be wrong. For example, if you initially think something is true,
              think of 2 reasons why it might actually be false. Or, if you
              initially think something is false, think of 2 reasons why it
              might actually be true. Then proceed to engage with the content as
              you normally would in real life (e.g., liking, disliking, sharing,
              or no engagement, etc.) before continuing to the next post.
            </p>
